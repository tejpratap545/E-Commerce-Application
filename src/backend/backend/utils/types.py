from .validators import get_digits
...
CC_TYPES = (
    ...
    (CC_TYPE_VISA, {"title": "Visa", "regex": re.compile(r"^4")}),
    (CC_TYPE_AMEX, {"title": "American Express", "regex": re.compile(r"^3[47]")}),
    (
        CC_TYPE_DINERS,
        {"title": "Diners Club", "regex": re.compile(r"^3(?:0[0-5]|095|[689])")},
    ),
    (
        CC_TYPE_DISCOVER,
        {"title": "Discover Card", "regex": re.compile(r"^6(?:011|4[4-9]|5)")},
    ),
    (CC_TYPE_JCB, {"title": "JCB", "regex": re.compile(r"^35(?:2[89]|[3-8])")}),
    (CC_TYPE_MIR, {"title": "MIR", "regex": re.compile(r"^220[0-4]")}),
    (CC_TYPE_UNIONPAY, {"title": "UnionPay", "regex": re.compile(r"^62")}),
    (
        CC_TYPE_MASTERCARD,
        {
            "title": "MasterCard",
    ...
    (
        INDIAN_RUPAY_DABIT_CARD,
        {
            "title": "Indian Rupay Dabit Card",
            # https://stackoverflow.com/questions/60785582/how-to-make-regular-expression-to-detect-rupay-debit-card
            "regex": re.compile(r"^(6(?!011)(?:0[0-9]{14}|52[12][0-9]{12})$)"),
        },
    ),
)
...
CC_TYPE_CHOICES = (
    ...
    (INDIAN_RUPAY_DABIT_CARD, "RupayCard"),
)
